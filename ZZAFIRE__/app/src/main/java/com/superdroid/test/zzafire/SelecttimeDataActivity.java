...
public class SelecttimeDataActivity extends AppCompatActivity {
    ...
    private class BleList extends BaseAdapter {
        ...
        public BleList() {
            ...
            inflater = ((Activity) SelecttimeDataActivity.this).getLayoutInflater();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.listview_time, null);
                viewHolder.devicebox= (CheckBox) convertView.findViewById(R.id.checkbox_name);
            ...
            viewHolder.devicebox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if(isChecked) {
                        Toast.makeText(SelecttimeDataActivity.this,viewHolder.devicebox.getText().toString()+"시작",Toast.LENGTH_SHORT).show();
                    }
